...
public class App {
    ...
    public static void question31() {
        final TD3.arbres.Arbre f1 = new TD3.arbres.Feuille(1);
        final TD3.arbres.Arbre f2 = new TD3.arbres.Feuille(2);
        final TD3.arbres.Arbre n1 = new TD3.arbres.Noeud(List.of(f1, f2));
        final TD3.arbres.Arbre f3 = new TD3.arbres.Feuille(3);
        final TD3.arbres.Arbre n2 = new TD3.arbres.Noeud(List.of(n1, f3));
    ...
    public static void question32() {
        ...
        final TD3.arbresgeneriques1.Arbre<Integer> if1 = new TD3.arbresgeneriques1.Feuille<>(1);
        final TD3.arbresgeneriques1.Arbre<Integer> if2 = new TD3.arbresgeneriques1.Feuille<>(2);
        final TD3.arbresgeneriques1.Arbre<Integer> in1 = new TD3.arbresgeneriques1.Noeud<>(List.of(if1, if2));
        final TD3.arbresgeneriques1.Arbre<Integer> if3 = new TD3.arbresgeneriques1.Feuille<>(3);
        final TD3.arbresgeneriques1.Arbre<Integer> in2 = new TD3.arbresgeneriques1.Noeud<>(List.of(in1, if3));
        ...
        final TD3.arbresgeneriques1.Arbre<String> sf1 = new TD3.arbresgeneriques1.Feuille<>("a");
        final TD3.arbresgeneriques1.Arbre<String> sf2 = new TD3.arbresgeneriques1.Feuille<>("b");
        final TD3.arbresgeneriques1.Arbre<String> sn1 = new TD3.arbresgeneriques1.Noeud<>(List.of(sf1, sf2));
        final TD3.arbresgeneriques1.Arbre<String> sf3 = new TD3.arbresgeneriques1.Feuille<>("c");
        final TD3.arbresgeneriques1.Arbre<String> sn2 = new TD3.arbresgeneriques1.Noeud<>(List.of(sn1, sf3));
    ...
    public static void question33() {
        ...
        final TD3.arbresgeneriques2.Arbre<Entier> if1 = new TD3.arbresgeneriques2.Feuille<>(new Entier(1));
        final TD3.arbresgeneriques2.Arbre<Entier> if2 = new TD3.arbresgeneriques2.Feuille<>(new Entier(2));
        final TD3.arbresgeneriques2.Arbre<Entier> in1 = new TD3.arbresgeneriques2.Noeud<>(List.of(if1, if2));
        final TD3.arbresgeneriques2.Arbre<Entier> if3 = new TD3.arbresgeneriques2.Feuille<>(new Entier(3));
        final TD3.arbresgeneriques2.Arbre<Entier> in2 = new TD3.arbresgeneriques2.Noeud<>(List.of(in1, if3));
        System.out.println(in2.taille());
        ...
        final TD3.arbresgeneriques2.Arbre<Chaine> sf1 = new TD3.arbresgeneriques2.Feuille<>(new Chaine("a"));
        final TD3.arbresgeneriques2.Arbre<Chaine> sf2 = new TD3.arbresgeneriques2.Feuille<>(new Chaine("b"));
        final TD3.arbresgeneriques2.Arbre<Chaine> sn1 = new TD3.arbresgeneriques2.Noeud<>(List.of(sf1, sf2));
        final TD3.arbresgeneriques2.Arbre<Chaine> sf3 = new TD3.arbresgeneriques2.Feuille<>(new Chaine("c"));
        final TD3.arbresgeneriques2.Arbre<Chaine> sn2 = new TD3.arbresgeneriques2.Noeud<>(List.of(sn1, sf3));
        System.out.println(sn2.taille());
